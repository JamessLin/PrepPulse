  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-4 py-12 dark:bg-gray-950 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto flex w-full flex-1 items-center justify-center">
        <div className="w-full max-w-md overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:border-gray-800 dark:bg-gray-900">
          {children}
        </div>
      </div>
    </div>
