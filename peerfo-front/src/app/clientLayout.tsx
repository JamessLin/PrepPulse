...
export default function RootLayout({
  ...
  const showNavAndFooter = !pathname.startsWith("/auth") && !pathname.startsWith("/interview") && !pathname.startsWith("/test");
        ...
        <ThemeProvider>
          <AuthProvider>
            <SocketProvider>
              ...
              <main className={showNavAndFooter ? "" : "pt-0"}>{children}</main>
              {showNavAndFooter && (
