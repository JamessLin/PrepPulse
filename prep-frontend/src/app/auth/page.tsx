                ...
                <div className="mt-10 space-y-6">
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row">
                    <Button
                      ...
                      className="w-full rounded-full border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                    >
                      Skip for now
                    </Button>
                    <Button
